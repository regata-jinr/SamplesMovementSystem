...
#define XEMO_DLL_FULLVERSION	STRINGIZE(VERSION_MAJOR) "." STRINGIZE(VERSION_MINOR) "." STRINGIZE(VERSION_REVISION) "." STRINGIZE(VERSION_BUILD)
#define XEMO_DLL_VESRION		STRINGIZE(VERSION_MAJOR) "." STRINGIZE(VERSION_MINOR)
...
MB4_API short __stdcall ML_IniTCP		( const char * IpAddr, long port);
MB4_API short __stdcall ML_IniTCPA		(short ComNo,  const char * IpAddr, long port);
...
MB4_API void  __stdcall ML_GetRunErrText ( char * ErrTxt, short MaxLen);
...
//----------------------------------------------------------------------
// Systemkontrolle
MB4_API void  __stdcall MB_SysCtrl	   (short Control);
...
MB4_API void  __stdcall MB_Outi        ( short ByteNr, short BitNr1, short BitNr2, short Wert );
...
MB4_API void  __stdcall MB_Outwi       ( short ByteNr, short Wert );
...
//----------------------------------------------------------------------
MB4_API int __stdcall BS_LoadFirmware (std::ifstream *fphexfile );
MB4_API int __stdcall BS_LoadFirmwareN (char * FileName);
MB4_API int __stdcall BS_LoadState (int * ProgressPos);
MB4_API int __stdcall BS_GenericCmd (unsigned char cmd);
