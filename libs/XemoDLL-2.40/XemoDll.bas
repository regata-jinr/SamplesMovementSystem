...
Public Const m_XEMODLL_H = 

Public Const XEMO_DLL_VESRION = "2.33"
...
Public Declare Function ML_IniTCP Lib "XemoDll.dll" Alias "_ML_IniTCP@8" (ByVal IpAddr As  String, ByVal port As long) As Integer
...
' ----------------------------------------------------------------------
'  Systemkontrolle
Public Declare Sub MB_SysCtrl Lib "XemoDll.dll" Alias "_MB_SysCtrl@4" (ByVal Control As Integer)
...
Public Declare Sub MB_Outi Lib "XemoDll.dll" Alias "_MB_Outi@16" (ByVal ByteNr As Integer, ByVal BitNr1 As Integer, ByVal BitNr2 As Integer, ByVal Wert As Integer)
...
Public Declare Sub MB_Outwi Lib "XemoDll.dll" Alias "_MB_Outwi@8" (ByVal ByteNr As Integer, ByVal Wert As Integer)
...
' ----------------------------------------------------------------------
'  Booter Setup Funktionen
' ----------------------------------------------------------------------
Public Declare Function BS_LoadFirmware Lib "XemoDll.dll" Alias "_BS_LoadFirmware@0" () As int
Public Declare Function BS_LoadFirmwareN Lib "XemoDll.dll" Alias "_BS_LoadFirmwareN@4" (ByVal FileName As  String) As int
Public Declare Function BS_LoadState Lib "XemoDll.dll" Alias "_BS_LoadState@4" (ByRef ProgressPos As int) As int
Public Declare Function BS_GenericCmd Lib "XemoDll.dll" Alias "_BS_GenericCmd@4" (ByVal cmd As char) As int
