...
Public Const PSTATE_DBGPRINT = &H20	'  Debug Print available
...
Public Const m_ReStart = 4		'  MotionBasic Programm neu starten (Warmstart)
...
'  Com-Device
Public Const COM_RS232 = 1
Public Const COM_USB = 2
Public Const COM_TCP = 3
Public Const TCP_PORT = 502
'  Diverse
Public Const m_Off = 0
Public Const m_On = 1

'  Winkeleinheit für Trigometrische Funktionen
Public Const m_Radian = 0
Public Const m_Degree = 1
...
'  Nur Amoxa
Public Const m_PartNo = 1001
Public Const m_EcLevel = 1002
Public Const m_SerialNo = 1003
...
Public Const m_Hour = 1130
Public Const m_Minute = 1131
Public Const m_Second = 1132
' #define _HSecond		1133
Public Const m_Day = 1134
Public Const m_Month = 1135
Public Const m_Year = 1136
...
Public Const m_ComDevice = 1407	'  (neu )Kommunikations Schnittstelle auswählen
Public Const m_USBSpeed = 1408	'  USB Full / High Speed (0= FullSpeed)
Public Const m_IpAddr = 1409	'  IP-Adresse
Public Const m_IpMask = 1410	'  IP-Maske
Public Const m_IpGateWay = 1411	'  IP ´Gateway Adresse
Public Const m_MacAddr1 = 1412	'  MAC-Adresse 3 ersten Bytes
Public Const m_MacAddr2 = 1413	'  MAC-Adresse 3 folgende Bytes

Public Const TOP_SUPARM_NO = 1413
...
Public Const m_Jerk = 2006
Public Const m_Jerkms = 2007
...
Public Const m_RunCurrDelay = 2054
Public Const m_StopCurrDelay = 2055

Public Const m_StpEncoder = 2056		'  Schrittüberwachung
' #define _StpEncIdx		2057	// Encoder Index lesen
' #define _StpEncIpr		2058	// Indexüberwachung
...
Public Const m_InPortExist = 4002
Public Const m_OutPortExist = 4003
...
Public Const ERR_HEXFILE_FORMAT = 13
...
Public Const ERR_EXT_DEVICE = 1	' 
Public Const ERR_I2C_ACKN = 2
Public Const ERR_I2C_COMM = 3
Public Const ERR_DATA_FORMAT = 4
Public Const ERR_DATA_CECKS = 5
